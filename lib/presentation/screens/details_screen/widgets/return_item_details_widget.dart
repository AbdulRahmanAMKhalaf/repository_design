...
class ReturnItemDetailsWidget extends StatelessWidget {
  const ReturnItemDetailsWidget({super.key});
      ...
      child: Padding(
        ...
        child: ExpansionTile(
          ...
          collapsedShape: OutlineInputBorder(
              ...
              borderSide: BorderSide(width: 1.w, color: Colors.redAccent.shade700)),
